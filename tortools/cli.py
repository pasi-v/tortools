...
@cli.command()
@click.option(
    "--skill", "-s", required=True, type=int, help="Skill rating of the character (1-6)"
)
@click.option("--tn", "-t", required=True, type=int, help="Target number for the test")
@click.option(
    "--advantage", "-a", is_flag=True, help="Whether the character has advantage"
)
@click.option(
    "--disadvantage", "-d", is_flag=True, help="Whether the character has disadvantage"
)
